...
#define TSK_ACTIVE_MM 1384 /* offsetof(struct task_struct, active_mm) */
...
#define THREAD_CPU_CONTEXT 3024 /* offsetof(struct task_struct, thread.cpu_context) */
...
#define PROOT_TSK_CRED 2008 /* offsetof(struct task_struct, cred) */
